...
namespace Ships
{
    public sealed class BulletView : MonoBehaviour, IUpdatable
    {
        public event Action<Collider2D, BulletView> OnTriggerEntered;
        public event Action<BulletView> OnDeactivated;
